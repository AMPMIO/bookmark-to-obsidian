...
# bookmark-to-obsidian: Bookmark Extractor Launcher
#
...
#
# Usage:
#   ./scripts/extract-bookmarks.sh [--config path/to/config.yaml]
#   ./scripts/extract-bookmarks.sh --save [--config path/to/config.yaml]
...
echo "  ./scripts/process-bookmarks.sh"
echo "  # or: claude /process-bookmarks"
